...
BDD.SIG <- function()
{
  ...
  SIG.exportSHP(Stations, Stations$XL93, Stations$YL93, "/Users/imac27/NAS-SIG/Données/Réseaux/Chroniques/Stations_chroniques")
  }
  ...
  if(file.exists("/Volumes/Fixe-FD39/NAS-DATA/Chroniques/BDD_Chroniques_FD39.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XL93, Stations$YL93, "/Volumes/Fixe-FD39/NAS-SIG/Données/Réseaux/Chroniques/Stations_chroniques")
  }
  ...
  if(file.exists("/Users/adrienlavigne/NAS-DATA/Chroniques/BDD_Chroniques_FD39.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XL93, Stations$YL93, "/Users/adrienlavigne/NAS-SIG/Données/Réseaux/Chroniques/Stations_chroniques")
  }
  ...
  Stations <- Stations %>% filter(TypeLambert == 'L93')
    ...
    SIG.exportSHP(Stations, Stations$XLambert, Stations$YLambert, "/Users/imac27/NAS-SIG/Données/Réseaux/Poissons/Stations_poissons")
  }
  ...
  if(file.exists("/Volumes/Fixe-FD39/NAS-DATA/Poissons/Base poisson FD/MaxiFish_V3/multifish - datas.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XLambert, Stations$YLambert, "/Volumes/Fixe-FD39/NAS-SIG/Données/Réseaux/Poissons/Stations_poissons")
  }
  ...
  if(file.exists("/Volumes/adrienlavigne/NAS-DATA/Poissons/Base poisson FD/MaxiFish_V3/multifish - datas.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XLambert, Stations$YLambert, "/Volumes/adrienlavigne/NAS-SIG/Données/Réseaux/Poissons/Stations_poissons")
  }
  ...
  if(file.exists("/Users/imac27/NAS-DATA/Physico-chimie/BDD_Physico-chimie_FD39.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XL93, Stations$YL93, "/Users/imac27/NAS-SIG/Données/Réseaux/Physico-chimie/Stations_PC")
  }
  ...
  if(file.exists("/Volumes/Fixe-FD39/NAS-DATA/Physico-chimie/BDD_Physico-chimie_FD39.sqlite") == T){
    ...
    SIG.exportSHP(Stations, Stations$XL93, Stations$YL93, "/Volumes/Fixe-FD39/NAS-SIG/Données/Réseaux/Physico-chimie/Stations_PC")
  }
