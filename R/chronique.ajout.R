...
#' @param cCodeRHJ CodeRHJ à ajouter
#' @param cCapteur Capteur à ajouter
#' @param cDate Date à ajouter
#' @param cHeure Heure à ajouter
...
chronique.ajout <- function(data, cCodeRHJ = "BONbaro", cCapteur = "P0352", cDate = "2014-12-27", cHeure = "19:00:00", cUnite = "°C", cTypeMesure = "Thermie", cNvelleValeur = 15, cValidation = "Validé", cModeAcquisition = "Estimé")
{
  ...
  LigneAjout$chmes_coderhj <- cCodeRHJ
